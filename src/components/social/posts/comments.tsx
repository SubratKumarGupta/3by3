...
const Replies: React.FC<{
  ...
  return (
    <>
        ...
        return (
          <div className=" relative mb-2" key={i}>
            ...
            <div className="content mb-2 text-white">
              ...
              porro doloriatis corporis iusto, cupiditate aspernatur at
      ...
      <div className="flex h-6 cursor-pointer justify-end text-gray-500 hover:text-white">
        Load more replies
      </div>
    </>
  );
