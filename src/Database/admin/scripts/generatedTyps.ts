...
export type CheckGenSchemaQuery = { __typename?: 'Query', getGQLSchema?: { __typename?: 'GQLSchema', generatedSchema: string } | null };

export type CheckSchemaQueryVariables = Exact<{ [key: string]: never; }>;


export type CheckSchemaQuery = { __typename?: 'Query', getGQLSchema?: { __typename?: 'GQLSchema', schema: string } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    checkGenSchema(variables?: CheckGenSchemaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CheckGenSchemaQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CheckGenSchemaQuery>(CheckGenSchemaDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'checkGenSchema', 'query');
    },
    checkSchema(variables?: CheckSchemaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CheckSchemaQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CheckSchemaQuery>(CheckSchemaDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'checkSchema', 'query');
    }
  };
}
